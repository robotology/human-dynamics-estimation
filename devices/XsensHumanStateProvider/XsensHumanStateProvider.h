...
#ifndef HDE_DEVICES_XSENSHUMANSTATEPROVIDER
#define HDE_DEVICES_XSENSHUMANSTATEPROVIDER
...
namespace hde {
    namespace devices {
        class XsensHumanStateProvider;
    } // namespace devices
} // namespace hde

class hde::devices::XsensHumanStateProvider final
...
public:
    XsensHumanStateProvider();
    ~XsensHumanStateProvider() override;
