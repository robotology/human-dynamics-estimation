...
#ifndef HDE_DEVICES_RETARGETINGPROVIDER
#define HDE_DEVICES_RETARGETINGPROVIDER
...
namespace hde {
    namespace devices {
        class RetargetingProvider;
    } // namespace devices
} // namespace hde

class hde::devices::RetargetingProvider final
...
#endif // HDE_DEVICES_RETARGETINGPROVIDER
